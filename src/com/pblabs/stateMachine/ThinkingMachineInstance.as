...
package com.pblabs.stateMachine
{
    ...
    import com.pblabs.engine.time.ThinkingComponent;
    ...
    public class ThinkingMachineInstance extends ThinkingComponent implements IMachine
    {
        ...
        public function tick():void
        {
            ...
            //Logger.print(this, "Ticked, now in " + getStateName(_currentState) + " from " + getStateName(_previousState) + "! duration=" + (context.processManager.virtualTime - _nextThinkTime));
