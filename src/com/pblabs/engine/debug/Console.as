...
package com.pblabs.engine.debug
{
    ...
    public class Console
    {
        ...
        protected static function _setPointProperty(reference:String, xIn:String, yIn:String):void
        {
            if (reference.substr(0, 1) != "#" && reference.substr(0, 1) != "!")
            {
                Logger.warn(Console, "setPoint", "set can only be used on named entites or templates. " +
                    "The PropertyReference must start with # or !.");
                return;
            }
