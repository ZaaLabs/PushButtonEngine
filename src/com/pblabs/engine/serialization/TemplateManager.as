    ...
    public class TemplateManager extends EventDispatcher
    {
            ...
            try
            {
                ...
                if (_things[name])
                {
                    ...
                    if (_things[name].entityCallback)
                    {
                        ...
                        if(!instantiated)
                            throw new Error("entityCallback returned NULL!");
        ...
        public function instantiateEntityFromXML(xml:XML):IEntity
        {
            ...
            try
            {
                ...
                var entity:IEntity = context.allocateEntity();
        ...
        {
            var version:int = data.attribute("version");
            ...
            Logger.print(this, "Loaded " + thingCount + " from " + sourceName);            
        }
