...
package com.pblabs.engine.serialization
{
	 ...
	 */
	[Event(name="READY_EVENT", type="com.pblabs.engine.serialization.LevelEvent")]
	
	/**
	 * @eventType com.pblabs.engine.core.LevelEvent.LEVEL_LOADED_EVENT
	 */
	[Event(name="LEVEL_LOADED_EVENT", type="com.pblabs.engine.serialization.LevelEvent")]
	
	/**
	 * @eventType com.pblabs.engine.core.LevelEvent.LEVEL_UNLOADED_EVENT
	 */
	[Event(name="LEVEL_UNLOADED_EVENT", type="com.pblabs.engine.serialization.LevelEvent")]
	...
	public class LevelManager extends EventDispatcher implements ISerializable
	{
		...
		{
			serializer.deserialize(this, resource.XMLData);
		...
		private function unload(filesToUnload:Array, groupsToUnload:Array):void
		{
			...
			for each (var groupName:String in groupsToUnload)
			{
				...
				if(groupName != context.rootGroup.name)
				{
					context.lookup(groupName).destroy();
		...
		private var _loadedGroups:Array = new Array();
