package com.pblabs.engine.core
{
    ...
    public class PBContext extends Sprite implements IPBContext
    {
        ...
        {
            return injector.getMapping(clazz, optionalName).getResponse(injector);
        }
		...
		public function registerManager(clazz:Class, instance:Object = null, optionalName:String="", suppressInject:Boolean = false):void
		{
            if(!instance)
            ...
            if(suppressInject == false)
			    injector.injectInto(instance);
            
            if(instance is IPBManager)
                (instance as IPBManager).startup();
		}
